...
![2D Cost Function Surface]({{site.url}}{{site.baseurl}}{{site.assets_path}}/img/grad-decent/2d-lr-surface.png?style=center "2D Cost Function Surface")
...
![GD Convex Function]({{site.url}}{{site.baseurl}}{{site.assets_path}}/img/grad-decent/gd-convex.png?style=center "GD Convex Function")
...
![GD Error w.r.t. Weight]({{site.url}}{{site.baseurl}}{{site.assets_path}}/img/grad-decent/error-wrt-w.jpg?style=center "GD Error w.r.t. Weight")
